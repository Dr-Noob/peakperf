#include "256_6.hpp"
#define OP_PER_IT B_256_6_OP_IT

TYPE farr_256_6[MAX_NUMBER_THREADS][SIZE] __attribute__((aligned(64)));

void compute_256_6(TYPE *farr, TYPE mult, int index) {
  farr = farr_256_6[index];
