...
TYPE farr_cannon_lake_512[MAX_NUMBER_THREADS][SIZE] __attribute__((aligned(64)));  

void cannon_lake_512(TYPE *farr, TYPE mult, int index) {
  farr = farr_cannon_lake_512[index];
