...
TYPE farr_skylake_128[MAX_NUMBER_THREADS][SIZE] __attribute__((aligned(64)));

void compute_skylake_128(TYPE *farr, TYPE mult, int index) {
  farr = farr_skylake_128[index];
