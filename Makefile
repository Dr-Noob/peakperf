...
ALL_OUTS=$(OUT_SANDY_BRIDGE) $(OUT_IVY_BRIDGE) $(OUT_HASWELL) $(OUT_SKYLAKE_256) $(OUT_SKYLAKE_512) $(OUT_BROADWELL) $(OUT_KABY_LAKE) $(OUT_COFFEE_LAKE) $(OUT_CANNON_LAKE_256) $(OUT_CANNON_LAKE_512) $(OUT_ICE_LAKE_256) $(OUT_ICE_LAKE_512) $(OUT_KNL) $(OUT_ZEN) $(OUT_ZEN_PLUS) $(OUT_ZEN2)
