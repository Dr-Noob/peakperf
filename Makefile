...
# INTEL #
OUTPUT_SANDY_BRIDGE=sandy_bridge
OUTPUT_IVY_BRIDGE=ivy_bridge
OUTPUT_HASWELL=haswell
OUTPUT_SKYLAKE=skylake
OUTPUT_BROADWELL=broadwell
OUTPUT_KABY_LAKE=kaby_lake
OUTPUT_COFFE_LAKE=coffe_lake
OUTPUT_CANNON_LAKE_256=cannon_lake_256
OUTPUT_CANNON_LAKE_512=cannon_lake_512
OUTPUT_ICE_LAKE_256=ice_lake_256
OUTPUT_ICE_LAKE_512=ice_lake_512
OUTPUT_KNL=knl

# AMD #
OUTPUT_ZEN=zen
OUTPUT_ZEN_PLUS=zen_plus
...
clean:
	@rm $(OUTPUT_SANDY_BRIDGE) $(OUTPUT_IVY_BRIDGE) $(OUTPUT_HASWELL) $(OUTPUT_SKYLAKE) $(OUTPUT_BROADWELL) $(OUTPUT_KABY_LAKE) $(OUTPUT_COFFE_LAKE) $(OUTPUT_CANNON_LAKE_256) $(OUTPUT_CANNON_LAKE_512) $(OUTPUT_ICE_LAKE_256) $(OUTPUT_ICE_LAKE_512) $(OUTPUT_KNL) $(OUTPUT_ZEN) $(OUTPUT_ZEN_PLUS)
